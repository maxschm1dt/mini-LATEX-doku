...
\begin{lstlisting}
    @book{zeleny1968wissenschaftslogik,
        title={Die Wissenschaftslogik bei Marx und Das Kapital},
        author={Zeleny, Jind{\v{r}}ich},
        year={1968},
...
\begin{lstlisting}
    \cite[]{zeleny1968wissenschaftslogik} % in der eckigen Klammer koennen wir noch extra Informationen, wie Seitenzahl angeben
\end{lstlisting}
