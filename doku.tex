...
Um in \LaTeX eine Mathematische Formel zu schreiben muss man dem Kompiler zuerst mitteilen, dass es jetzt Mathematisch wird:
\begin{itemize}
    \item Man kann die Formal entweder inline: \lstinline|$ 2 + 2 = 3 $|
    \item oder als eigenen Absatz formatieren lassen: \lstinline|$$ a \in A $$|
\end{itemize}
Inline sieht eine Formel dann so aus: $ 2 + 2 = 3 $ und als eigener Absatz: $$ a \in A$$
